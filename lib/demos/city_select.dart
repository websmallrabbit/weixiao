...
import 'package:weixiao/pages/label_page.dart';
...
class _CitySelectRouteState extends State<CitySelectRoute> {
  ...
  void loadData() async {
    _hotCityList.add(CityInfo(name: "北京大学", tagIndex: "#"));
    _hotCityList.add(CityInfo(name: "清华大学", tagIndex: "#"));
    _hotCityList.add(CityInfo(name: "交通大学", tagIndex: "#"));
    _hotCityList.add(CityInfo(name: "复旦大学", tagIndex: "#"));
    //加载城市列表
    rootBundle.loadString('data/university.json').then((value) {
